    ...
    <section className="py-8 sm:py-12 lg:py-16 bg-vibrant-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-vibrant-purple to-vibrant-green1 rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl">
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="relative h-48 sm:h-64 md:h-80 lg:h-auto">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#FFFFE0] to-[#FFDAB9] opacity-30"></div>
          ...
          {blogPosts.slice(1).map((post, index) => (
            ...
            >
              ...
              <div className="p-4 sm:p-5 md:p-6 lg:p-7">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3 line-clamp-2 group-hover:text-[#F0E68C] transition-colors">
                ...
                <Link
                  to={`/blog/${post.slug}`}
                  className="inline-flex items-center text-[#D1BF00] hover:text-[#DAA520] font-medium text-sm group-hover:translate-x-1 transition-all duration-200"
                >
                  Read More
        ...
        >
          <Link
            to="/blog"
            className="inline-flex items-center px-8 py-3 bg-[#FFE4C4] text-white font-semibold rounded-xl hover:bg-[#FFDAB9] transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
          >
            View All Articles
