            ...
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 lg:sticky lg:top-8">
              <div className="flex items-center justify-between mb-4 sm:mb-6">
                ...
                <button
                  ...
                  className="text-xs sm:text-sm text-pink-600 hover:text-pink-700 font-medium px-2 py-1 rounded hover:bg-pink-50 transition-colors"
                >
                  Clear All
                </button>
              </div>
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 sm:py-3 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-colors"
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <div className="space-y-2">
                  <input
                    ...
                    aria-label={`Price range up to $${priceRange.max}`}
                  />
              ...
              {availableBrands.length > 0 && (
                <div className="mb-4 sm:mb-6">
                  ...
                  <div className="space-y-2 max-h-32 sm:max-h-40 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                    {availableBrands.map(brand => (
                      <label key={brand} className="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded transition-colors">
                        <input
                          type="checkbox"
                          checked={selectedBrands.includes(brand)}
                          onChange={() => handleBrandToggle(brand)}
                          className="rounded border-gray-300 text-pink-600 focus:ring-pink-500 focus:ring-offset-0 w-4 h-4"
                        />
